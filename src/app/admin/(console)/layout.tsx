      ...
      <div className="panel flex flex-wrap items-center justify-between gap-3 px-5 py-4 sm:px-6">
        ...
        <div className="flex flex-wrap items-center gap-3 text-sm">
          ...
          <Link
            ...
            className="font-medium text-[var(--accent)] transition hover:opacity-90"
          >
            New site
          </Link>
          <form action={signOutAdmin}>
            <button
              type="submit"
              className="rounded-[var(--r-s)] border border-[var(--border)] px-3 py-1.5 text-[var(--muted)] transition hover:text-[var(--ink)]"
            >
              Sign out
            </button>
          </form>
